export const INSTALL_SYMBOL = Symbol.for("kendex.pi-qol.installed");
...
export const QUESTION_SERVICE_SYMBOL = Symbol.for("kendex.pi-questions.service");
export const QOL_NOTIFICATION_SERVICE_SYMBOL = Symbol.for("kendex.pi-qol.notification-service");
...
export const THINKING_TIMER_STORE_SYMBOL = Symbol.for("kendex.pi-qol.thinking-timer.store");
export const THINKING_TIMER_PATCH_SYMBOL = Symbol.for("kendex.pi-qol.thinking-timer.patch");
export const SESSION_SEARCH_PENDING_SYMBOL = Symbol.for("kendex.pi-qol.session-search.pending-context");
export const PENDING_QUEUE_THEME_PATCH_SYMBOL = Symbol.for("kendex.pi-qol.pending-queue.theme-patch");
export const STATUS_TEXT_ALIGNMENT_PATCH_SYMBOL = Symbol.for("kendex.pi-qol.status-text-alignment-patch");

export const QUESTION_OPENED_EVENT = "kendex:pi-questions:opened";
