...
export const INSTALL_SYMBOL = Symbol.for("kendex.pi-skills-manager.installed");
export const STARTUP_PATCH_SYMBOL = Symbol.for("kendex.pi-skills-manager.startup-patch");
export const STARTUP_HIDE_ENABLED_SYMBOL = Symbol.for("kendex.pi-skills-manager.hide-startup-skills");
