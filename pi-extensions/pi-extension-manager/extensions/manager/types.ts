...
export const EXTERNAL_CONFIG_RESOLVER_SYMBOL = Symbol.for("kendex.pi.extension-config-resolver");
export const KENDEX_OPEN_QUICK_SETTINGS_SYMBOL = Symbol.for("kendex.pi.extension-manager.open-quick-settings");
...
export interface InventoryItem {
	...
	updateSource?: "kendex" | "npm";
	updateCommand?: string;
	installSource?: "kendex" | "npm" | "unknown";
	npmName?: string;
	sourceRepo?: string;
}
