...
- Participates in kendex's stable mini-dashboard stack order: Orch → Tasks → Agents → BG tasks.
...
kendex add vanillagreencom/kendex --pi-extension pi-task-panel --harness pi -y
```
