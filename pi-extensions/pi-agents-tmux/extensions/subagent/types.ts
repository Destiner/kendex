...
export const INSTALL_SYMBOL = Symbol.for("kendex.pi-agents-tmux.installed");
export const STATUSLINE_SYMBOL = Symbol.for("kendex.pi-agents-tmux.statusline");
export const STATS_BRIDGE_SYMBOL = Symbol.for("kendex.pi.agents");
...
export const DEFAULT_RESULT_MAX_BYTES = 32 * 1024;
export const DEFAULT_RESULT_MAX_LINES = 1_200;
