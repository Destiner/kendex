...
describe("wake payload byte budget (kendex#210)", () => {
	...
	test("details.matchedPattern is bounded by the manifest cap (kendex#210 round 2)", () => {
...
describe("default notifyMode resolution (kendex#210)", () => {
...
describe("output wake budget guard (kendex#210)", () => {
	const limits = {
