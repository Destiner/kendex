...
# their own manifest instead of failing `-p` resolution (kendex#742), and
...
echo "=== pre-commit-check Rust clippy lane (kendex#737, kendex#742) ==="
...
# --- Workspace-excluded crate lints against its own manifest (kendex#742) -----
